...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user::user.allUser',compact('allUser'));
    }

    public function create()
    {
        $roles = Role::pluck('name','name')->all();
        return view('user::user.createUser',compact('roles'));
    }
    ...
    public function activeLog()
    {
        ...
        foreach($activities as $activity) {
         ...
         return view('user::user.activity',compact('activities','arr'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('user::user.createUser',compact('user','roles','userRole'));
